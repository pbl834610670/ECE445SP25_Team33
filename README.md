...
## 04/28/2025
Tomorrow is our final demo. During today’s testing, I realized that the code still needed some adjustments. I spent the evening refining it, and by the end of the night, the robot was operating smoothly on the table surface. I also noticed that for more reliable edge detection, the IR sensors needed to be positioned farther from the wheels to allow more response time. To address this, I attached two small cardboards to the front of the robot car and pasted the IR sensors on them. I tested the robot’s functionality on a table at home, and it worked perfectly. However, I still need to confirm its performance on the lab table. The jack port for our PCB board has not yet arrived, so we’ll have to wait until tomorrow morning to test whether the PCB board can work.
